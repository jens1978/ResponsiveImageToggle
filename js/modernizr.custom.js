 ...
 * Build: http://modernizr.com/download/#-fontface-backgroundsize-borderimage-borderradius-boxshadow-hsla-multiplebgs-opacity-rgba-textshadow-cssanimations-csscolumns-generatedcontent-cssgradients-cssreflections-csstransforms-csstransforms3d-csstransitions-applicationcache-canvas-canvastext-draganddrop-hashchange-history-audio-video-indexeddb-input-inputtypes-localstorage-postmessage-sessionstorage-websockets-websqldatabase-webworkers-inlinesvg-webgl-printshiv-mq-cssclasses-prefixed-teststyles-testprop-testallprops-hasevent-prefixes-domprefixes-a_download-audio_webaudio_api-contenteditable-contextmenu-cookies-cors-css_backgroundposition_shorthand-css_backgroundposition_xy-css_backgroundrepeat-css_backgroundsizecover-css_boxsizing-css_calc-css_filters-css_hyphens-css_lastchild-css_mask-css_mediaqueries-css_overflow_scrolling-css_pointerevents-css_positionsticky-css_supports-forms_validation-ie8compat-iframe_sandbox-iframe_seamless-iframe_srcdoc-svg_filters-unicode-url_data_uri-load-cssclassprefix:mod!
 */
;
...
Modernizr.addTest('cors', !!(window.XMLHttpRequest && 'withCredentials' in new XMLHttpRequest()));// Detect support for svg filters - http://www.w3.org/TR/SVG11/filters.html.
